...
func TestIsRotateSorted(t *testing.T) {
	...
	tests := []struct {
		...
		{"Not rotated sorted", args{[]int{2, 3, 4, 5, 1}}, false},                  // Not a rotated sorted array
		{"Two elements sorted", args{[]int{1, 2}}, true},                           // Two elements in order
		{"Two elements not sorted", args{[]int{2, 1}}, false},                      // Two elements out of order
		{"Multiple rotations", args{[]int{4, 5, 6, 7, 0, 1, 2}}, true},             // Multiple rotations
		{"Multiple rotations not sorted", args{[]int{4, 5, 6, 7, 8, 0, 1}}, false}, // A rotated sorted array
